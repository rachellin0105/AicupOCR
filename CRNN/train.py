...
if __name__ == '__main__':
    ...
    parser.add_argument('--valInterval', type=int, default=9000, help='Interval between each validation')
    ...
    parser.add_argument('--dic_path', type=str, default="", help='path of dic')
    ...
    try:
    	with open("./dic_ch.txt",'r',encoding="utf8") as f :
